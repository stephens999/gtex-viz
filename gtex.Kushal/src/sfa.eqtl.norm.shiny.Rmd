...
lambda=as.matrix(read.table("../data/sfa_MatrixEqtl_norm_shrink_30/sfa_MatrixEqtl_norm_shrink_30_lambda.out"));
fac_mat=as.matrix(read.table("../data/sfa_MatrixEqtl_norm_shrink_30/sfa_MatrixEqtl_norm_shrink_30_F.out"));
